...
La mayor parte de esta sección se **autogenera** desde los repos de Aurora mediante el script `import-from-sources`. No edites las páginas autogeneradas a mano — se sobreescriben en el próximo `pnpm sync`.
