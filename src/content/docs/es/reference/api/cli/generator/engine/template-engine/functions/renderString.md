...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/es/reference/api/cli/readme/) / [generator/engine/template-engine](/aurora-catalyst-docs/es/reference/api/cli/generator/engine/template-engine/readme/) / renderString
...
as [render](/aurora-catalyst-docs/es/reference/api/cli/generator/engine/template-engine/functions/render/).
...
[`TemplateData`](/aurora-catalyst-docs/es/reference/api/cli/generator/engine/template-engine/interfaces/templatedata/)
