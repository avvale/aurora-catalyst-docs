...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/es/reference/api/cli/readme/) / [generator/domain/model](/aurora-catalyst-docs/es/reference/api/cli/generator/domain/model/readme/) / PropertyWebComponent
...
> **property**: [`Property`](/aurora-catalyst-docs/es/reference/api/cli/generator/domain/model/interfaces/property/)
...
Back-reference to the owning [Property](/aurora-catalyst-docs/es/reference/api/cli/generator/domain/model/interfaces/property/). Used by templates.

***

### type

> **type**: [`WebComponentType`](/aurora-catalyst-docs/es/reference/api/cli/generator/domain/model/type-aliases/webcomponenttype/)
