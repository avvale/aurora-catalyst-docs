...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/es/reference/api/cli/readme/) / [deploy/ports/hosting.port](/aurora-catalyst-docs/es/reference/api/cli/deploy/ports/hostingport/readme/) / HostingPort
...
[`DatabaseType`](/aurora-catalyst-docs/es/reference/api/cli/deploy/domain/model/type-aliases/databasetype/)
...
> **createSubscription**(`params`): `Promise`\<[`SubscriptionResult`](/aurora-catalyst-docs/es/reference/api/cli/deploy/domain/model/interfaces/subscriptionresult/)\>
...
`Promise`\<[`SubscriptionResult`](/aurora-catalyst-docs/es/reference/api/cli/deploy/domain/model/interfaces/subscriptionresult/)\>
