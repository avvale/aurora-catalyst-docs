...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/es/reference/api/cli/readme/) / [deploy/ports/cicd.port](/aurora-catalyst-docs/es/reference/api/cli/deploy/ports/cicdport/readme/) / CiCdPort
