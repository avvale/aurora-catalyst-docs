...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [generator/domain/model](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/readme/) / ModuleDefinitionSchema
...
> `optional` **gender?**: [`Gender`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/type-aliases/gender/)
