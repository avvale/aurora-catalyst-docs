...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [generator/domain/model](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/readme/) / Property
...
> `optional` **arrayOptions?**: [`PropertyArrayOptions`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/interfaces/propertyarrayoptions/)
...
Overrides the default seed picked from [PropertyType](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/type-aliases/propertytype/).

***

### index?

> `optional` **index?**: [`PropertyIndex`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/type-aliases/propertyindex/)
...
> `optional` **indexUsing?**: [`PropertyIndexUsing`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/type-aliases/propertyindexusing/)
...
> `optional` **relationship?**: [`PropertyRelationship`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/interfaces/propertyrelationship/)
...
> `optional` **webComponent?**: [`PropertyWebComponent`](/aurora-catalyst-docs/en/reference/api/cli/generator/domain/model/interfaces/propertywebcomponent/)
