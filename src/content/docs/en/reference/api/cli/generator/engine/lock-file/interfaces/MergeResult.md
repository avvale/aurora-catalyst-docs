...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [generator/engine/lock-file](/aurora-catalyst-docs/en/reference/api/cli/generator/engine/lock-file/readme/) / MergeResult
...
Outcome of [mergePreservationRegions](/aurora-catalyst-docs/en/reference/api/cli/generator/engine/lock-file/functions/mergepreservationregions/).
