...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [deploy/ports/logger.port](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/loggerport/readme/) / LoggerPort
...
> **step**(`label`): [`Spinner`](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/loggerport/interfaces/spinner/)
...
[`Spinner`](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/loggerport/interfaces/spinner/)
