...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [deploy/ports/dns.port](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/dnsport/readme/) / DnsPort
...
> **upsertRecord**(`params`): `Promise`\<[`DnsRecordResult`](/aurora-catalyst-docs/en/reference/api/cli/deploy/domain/model/interfaces/dnsrecordresult/)\>
...
`Promise`\<[`DnsRecordResult`](/aurora-catalyst-docs/en/reference/api/cli/deploy/domain/model/interfaces/dnsrecordresult/)\>
