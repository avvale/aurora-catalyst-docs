...
[@aurorajs.dev/catalyst-cli](/aurora-catalyst-docs/en/reference/api/cli/readme/) / [deploy/ports/logger.port](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/loggerport/readme/) / Spinner
...
Progress indicator returned by [LoggerPort.step](/aurora-catalyst-docs/en/reference/api/cli/deploy/ports/loggerport/interfaces/loggerport/#step). Backed by `ora` in
